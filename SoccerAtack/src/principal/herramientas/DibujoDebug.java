...
public class DibujoDebug {
    ...
    public static void dibujarImagen(final Graphics g, final BufferedImage imagen, final int x, final int y) {
        objetosDibujados++;
    ...
    public static void dibujarRectangulContorno(final Graphics g, final int x, final int y, final int ancho, final int alto, final Color c) {
        objetosDibujados++;
        g.setColor(c);
        g.drawRect(x, y, ancho, alto);
    }
    ...
    public static int obtenerOPS() {
        return objetosDibujados;
    }

    public static void reiniciarContadorOPS() {
        objetosDibujados = 0;
    }
